...
<html lang="en">
    <head>
        ...
        {{-- {{asset}} it will redirect me to pubic folder then show the css files --}}
        <link href="{{asset('UI/backend/css/styles.css')}}" 
        rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        ...
        <script src="{{asset('UI/backend/assets/demo/chart-pie-demo.js')}}"></script>
    </body>
</html>
